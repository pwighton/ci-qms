...
|-------------|----------|----------------|
| SOP-006 | _(assigned on release)_ | _(assigned on release)_ |
...
This procedure applies to the selection, qualification, contracting, and
oversight of external organizations that perform study-related activities on
behalf of __NewInstitute__ for *observational studies*.
